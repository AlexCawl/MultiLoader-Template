...
internal abstract class AccessFeatureImpl @Inject constructor(
    ...
    override fun install(
        ...
        with(configuration) {
            project.configureAccess(neoForgeAccessTransformer, artifacts, directArtifacts)
        }
    }
    ...
    private fun Project.configureAccess(
        ...
        val extraction = registerAccessTransformerExtraction(artifacts, directArtifacts)
